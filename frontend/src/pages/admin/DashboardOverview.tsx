  ...
  return (
    <div id="admin-dashboard-overview" className="p-6 md:p-8 space-y-8 text-left">
      ...
      <section className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2 bg-stone-900 border border-stone-800 rounded-lg px-3 py-1.5 text-stone-300 font-mono text-[10px]">
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <div className="bg-stone-900 border border-stone-850 p-6 rounded-xl flex items-center justify-between shadow">
          <div className="space-y-1.5">
            <span className="font-mono text-3xs font-semibold text-stone-400 uppercase tracking-wider block">
              Proyectos Registrados
            </span>
            <strong className="text-3xl font-sans font-extrabold text-stone-50 leading-none block">
              {stats.totalProjects}
            </strong>
            <span className="text-emerald-500 font-mono text-[10px]">6 Zonas Habilitadas</span>
          </div>
          <div className="p-3 bg-stone-850/60 text-amber-500 rounded-xl shrink-0">
        ...
        <div className="bg-stone-900 border border-stone-850 p-6 rounded-xl flex items-center justify-between shadow">
          ...
          <div className="p-3 bg-stone-850/60 text-emerald-500 rounded-xl shrink-0">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-stone-900 border border-stone-850 p-5 rounded-xl flex flex-col justify-between">
          <div className="mb-4">
            <span className="font-mono text-3xs font-bold text-amber-500 uppercase tracking-widest block mb-0.5">
              Fluidez de Leads
            </span>
            <h3 className="font-sans font-bold text-sm text-stone-200">
        ...
        <div className="lg:col-span-4 bg-stone-900 border border-stone-850 p-5 rounded-xl flex flex-col justify-between">
          <div className="mb-2">
            <span className="font-mono text-3xs font-bold text-amber-500 uppercase tracking-widest block mb-0.5">
          ...
          <div className="h-56 w-full flex items-center justify-center relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <span className="text-2xl font-sans font-extrabold text-stone-50 leading-none">
                {stats.totalProjects}
              </span>
              <span className="text-3xs font-mono text-stone-500 block mt-0.5">TOTAL LOTE</span>
            </div>
          </div>

          {/* Labels keys legened */}
          <div className="grid grid-cols-2 gap-2 text-3xs font-mono text-stone-400">
      ...
      <section className="bg-stone-900 border border-stone-855 rounded-xl overflow-hidden shadow">
        
        {/* Table action bars header */}
        <div className="p-5 border-b border-stone-850 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h2 className="font-sans font-extrabold text-stone-100 text-sm tracking-wide">
              MECÁNICAS DE LEADS (MENSAJES ENTRANTE DE COMPRA)
            </h2>
            <p className="font-mono text-3xs text-stone-500">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
            ...
            <div className="relative w-full sm:w-56">
              ...
              <input
                ...
                className="w-full bg-stone-950 border border-stone-800 focus:border-amber-400 text-stone-50 text-[11px] p-2 pl-8 rounded-lg outline-none"
              />
            </div>
        ...
        <div className="overflow-x-auto">
          {filteredLeadsList.length === 0 ? (
            <div className="p-12 text-center space-y-2">
              <Users2 className="w-10 h-10 text-stone-600 mx-auto" />
              <h4 className="text-sm font-bold text-stone-400 font-sans">Sin contactos encontrados</h4>
            ...
            <table className="w-full text-left font-sans text-xs text-stone-300 border-collapse">
              <thead>
                <tr className="bg-stone-950 font-mono text-[10px] uppercase text-stone-500 border-b border-stone-850">
              ...
              <tbody className="divide-y divide-stone-850">
                {filteredLeadsList.map((lead) => (
                  <tr key={lead.id} className="hover:bg-stone-850/40 group transition-colors">
                    ...
                    <td className="p-4">
                      <div className="font-mono text-[11px]">
                        ...
                        <span className="block text-stone-500 text-3xs font-light">{lead.email}</span>
                      </div>
                    </td>
                    <td className="p-4">
                      <span className="bg-stone-950 border border-stone-800 text-[10px] px-2 py-0.5 rounded font-mono text-emerald-500">
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-1.5 opacity-80 group-hover:opacity-100 transition-opacity">
                        <button
                          ...
                          className="bg-stone-800 hover:bg-stone-750 text-stone-200 border border-stone-750 hover:border-stone-650 px-2.5 py-1 rounded text-2xs font-bold uppercase transition-colors"
                        >
                          Seguimiento
                        </button>
                        <button
                          ...
                          className="p-1 px-1.5 border border-transparent hover:border-stone-800 rounded hover:bg-stone-950 text-stone-500 hover:text-rose-500 transition-all"
                          title="Eliminar Lead"
                        >
      ...
      {selectedLead && (
        <section className="fixed inset-0 bg-stone-950/80 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-[#191716] border border-stone-800 rounded-xl w-full max-w-md p-6 relative space-y-6 text-stone-100">
            <button
              onClick={() => setSelectedLead(null)}
              className="absolute top-4 right-4 p-1.5 hover:bg-stone-850 rounded-lg text-stone-450 transition-colors"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            <div className="space-y-1">
              ...
              <h3 className="font-sans font-extrabold text-base text-stone-200">
                Seguimiento de Lead
              </h3>
            ...
            <div className="bg-stone-950 border border-stone-850 p-4 rounded-lg space-y-2.5 font-sans">
              <div className="flex justify-between items-start">
                <strong className="text-xs text-stone-300 block font-sans">
              ...
              <div className="text-3xs font-mono text-stone-500 space-y-0.5">
              ...
              <blockquote className="text-3xs text-stone-400 italic bg-stone-900/50 p-1.5 rounded leading-relaxed border-l-2 border-emerald-500">
            ...
            <form onSubmit={handleUpdateLead} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full bg-stone-950 border border-stone-800 text-stone-100 p-2.5 text-xs rounded-lg outline-none"
                >
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-stone-950 border border-stone-800 text-stone-100 p-2.5 text-xs rounded-lg outline-none resize-none"
                />
              </div>
              ...
              <div className="pt-2 flex items-center gap-3">
                <button
                  type="button"
                  onClick={() => setSelectedLead(null)}
                  className="flex-1 py-2 bg-transparent text-stone-400 hover:text-stone-200 text-xs font-semibold uppercase text-center"
                >
                  Cancelar
                </button>
                <button
